...
module.exports = {
  ...
  BACKTEST: { // 5xx
    ...
    INVALID_MARGIN: { res: 'invalid margin flag', code: 521 },
    INVALID_USE_MAX_LEVERAGE: { res: 'invalid useMaxLeverage flag', code: 522 },
    INVALID_LEVERAGE: { res: 'invalid leverage value', code: 523 },
    INVALID_INCREASE_LEVERAGE: { res: 'invalid increaseLeverage flag', code: 524 },
    INVALID_ADD_STOP_ORDER: { res: 'invalid addStopOrder flag', code: 525 },
    INVALID_STOP_ORDER_PERCENT: { res: 'invalid stopOrderPercent percent', code: 526 }
  }
}
