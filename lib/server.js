...
class Server {
   ...
   * @param {object} args.agent - optional proxy agent for bfx proxy connection
   ...
   * @param {boolean} args.proxy - if true, a bfx proxy will be opened for every client
  ...
  expectSync ({ exchange, symbol, tf, start, end }) {
    const key = Server.getSyncKeyforRange({
