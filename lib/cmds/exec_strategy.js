...
function generateResults (perfManager, btState = {}) {
  ...
  const allocation = perfManager.allocation.toString()
  const positionSize = perfManager.positionSize().toString()
  const currentAllocation = perfManager.currentAllocation().toString()
  const availableFunds = perfManager.availableFunds.toString()
  const equityCurve = perfManager.equityCurve().toString()
  const ret = perfManager.return().toString()
  const retPerc = perfManager.returnPerc().toString()
  const drawdown = perfManager.drawdown().toString()
