...
module.exports = async (ds, ws, msg) => {
  ...
  const [
    ...
    exchange, strategyId, start, end, symbol, timeframe, includeCandles, includeTrades, candleSeed, sync = true, margin = false, strategyContent, executionId, constraints = {}, leverageSettings = {}, stopOrderSettings = {}
  ] = msg[1] || []
