 ...
 * @private
 *
 * @param {bfx-hf-models.HFDB} db - database instance
 * @param {ws.WebSocket} ws - client
 * @param {bfx-api-node-rest.RESTv2} rest - rest client
 * @param {bfx-hf-data-server.BacktestParameters} btArgs - bt args
 */
